...
int main(int argc, char ** args)
{
    ...
    //创建窗口  
    auto  output_window_fu = std::async(output_windows_thread, "output_window");
    auto  superposition_window_fu = std::async(output_windows_thread, "superposition_window");
    ...
    */
    ...
    //等待窗口程序结束
    superposition_window_fu.wait();
    output_window_fu.wait();
    return 0;
}
